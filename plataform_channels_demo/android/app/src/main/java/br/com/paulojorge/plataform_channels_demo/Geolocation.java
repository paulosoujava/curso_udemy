...
public class Geolocation implements MethodChannel.MethodCallHandler, EventChannel.StreamHandler {
    ...
    Geolocation(Activity activity, FlutterEngine flutterEngine) {
        ...
        MethodChannel channel = new MethodChannel(messenger, "br.com.paulojorge.plataform_channels_demo");
        EventChannel eventChannel = new EventChannel(messenger, "br.com.paulojorge.plataform_channels_demo.listener");
        eventChannel.setStreamHandler(this);
        channel.setMethodCallHandler(this);
        ShimPluginRegistry registry = new ShimPluginRegistry(flutterEngine);
        PluginRegistry.Registrar registrar = registry.registrarFor("br.com.paulojorge.plataform_channels_demo");
