...
class Geolocation: NSObject, CLLocationManagerDelegate, FlutterStreamHandler {
    ...
    init(messenger: FlutterBinaryMessenger) {
        super.init()
        let channel = FlutterMethodChannel(name: "br.com.paulojorge.plataform_channels_demo", binaryMessenger: messenger)
        let eventChannel = FlutterEventChannel(name: "br.com.paulojorge.plataform_channels_demo.listener", binaryMessenger: messenger)
